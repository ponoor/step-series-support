...
slug: alarm-settings
lang: en
link: "https://ponoor.com/en/docs/step-series/osc-command-reference/alarm-settings/"
date: "2020-11-05T12:31:00"
modified: "2021-08-30T12:01:45"
parent: 886
menu_order: 49
---
...
| TH\_STATUS | Thermal status | Set condition | Release condition |
| --- | --- | --- | --- |
| 0 | Normal | - | - |
| 1 | Warning | 135℃ | 125℃ |
...
| --- | --- | --- |
| motorID | 1-4/1-8, 255 | motor ID |
| OCD\_TH | 0-31/0-15 | Overcurrent detection threshold |

##### Overcurrent detection threshold - STEP400

| OCD\_TH | Overcurrent detection threshold |
| --- | --- |
| 0 | 312.5mA |
| 1 | 625mA |
| ... | ... |
...
| --- | --- | --- |
| motorID | 1-4/1-8, 255 | motor ID |
| STALL\_TH | 0-31/0-127 | Stall detection threshold |

##### Stall detection threshold - STEP400

| STALL\_TH | Stall detection threshold |
| --- | --- |
| 0 | 312.5mA |
| 1 | 625mA |
| ... | ... |
