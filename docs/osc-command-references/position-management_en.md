...
lang: en
link: "https://ponoor.com/en/docs/step-series/osc-command-reference/position-management/"
date: "2020-11-05T12:33:26"
modified: "2022-04-04T22:47:44"
parent: 886
menu_order: 73
---
...
Rewrites ABS\_POS register to the specified coordinates. The current motor position is set to the specified coordinates.
...
Returns the contents of the ABS\_POS register (current position).
...
| ABS\_POS | -2,097,152 - 2,097,151 | current position |
