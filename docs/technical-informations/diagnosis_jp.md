...
slug: diagnosis
lang: ja
link: "https://ponoor.com/docs/step-series/technical-information/diagnosis/"
date: "2021-03-23T14:22:57"
modified: "2021-09-03T13:28:39"
parent: 363
menu_order: 64
---
...
| 文言 | 説明 |
| --- | --- |
| CONFIG\_VERSION\_UNDEFINED | configのバージョン未定義 |
| CONFIG\_VERSION\_NOTLOADED | configがmicroSDから読み込まれていない |
| CONFIG\_VERSION\_OLD | configのバージョンが古い |
| CONFIG\_VERSION\_APPLICABLE | configとファームウェアのバージョンが合っている |
| CONFIG\_VERSION\_NEW | configのバージョンが新しい（ファームウェアが古い） |
...
| --- | --- |
| BRAKE\_ENGAGED | ブレーキ保持状態 |
| BRAKE\_DISENGAGE\_WAITING | ブレーキ開放状態へ移行中 |
| BRAKE\_DISENGAGED | ブレーキ開放状態 |
| BRAKE\_MOTORHIZ\_WAITING | ブレーキ保持状態へ移行中 |

#### Homing status

| Number | Homing status | Description |
| --- | --- | --- |
| 0 | HOMING\_UNDEFINED | 原点復帰を行っていない状態 |
| 1 | HOMING\_GOUNTIL | センサへ向かって移動中 |
| 2 | HOMING\_RELEASESW | センサ反応範囲から脱出中 |
| 3 | HOMING\_COMPLETED | 原点復帰完了済み |
| 4 | HOMING\_TIMEOUT | 原点復帰中にタイムアウトした |
